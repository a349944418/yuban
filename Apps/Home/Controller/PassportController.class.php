...
Class PassportController extends BaseController
{
	...
	public function login()
	{
        ...
        $return = array('uid'=>$res['uid'], 'token'=>$res['token'], 'voipaccount'=>$res['voipaccount'], 'voippwd'=>$res['voippwd'], 'subaccountid'=>$res['subaccountid'], 'subtoken'=>$res['subtoken'], 'uname'=>$res['uname'], 'mobile'=>$res['mobile']);
        unset($res);
